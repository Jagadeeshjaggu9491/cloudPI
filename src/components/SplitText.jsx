...
const SplitText = ({
  ...
  useGSAP(
    () => {
      if (!ref.current || (!text && !children) || !fontsLoaded || animationCompletedRef.current) return;
      ...
      if (el._rbsplitInstance) {
        try {
          ...
          // SplitText may already be reverted during React cleanup.
        }
      ...
      const assignTargets = (self) => {
        ...
        if (!targets) targets = [self.chars, self.words, self.lines].find((group) => group?.length) || [];
      };
