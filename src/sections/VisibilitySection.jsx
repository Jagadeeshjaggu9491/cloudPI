...
import VisibilityChart from '../assets/images/visibility-chart.svg';
import VisibilityBg from '../assets/images/visibility-bg.png';
                    ...
                    <div className="col-lg-7">
                        <div className="cards-wrapper">
                            ...
                            <div
                                ...
                                style={{
                                    backgroundImage: `url(${VisibilityBg})`,
                                }}
                            >
                                <div className="chart-overlay">
                                    <img src={VisibilityChart} alt="Sales overview"/>
                                </div>
                            </div>
                        </div>
                    </div>
